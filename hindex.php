...
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      <div class="logo"><h1><a href="hindex.php" class="nobg"><img src="images/logo.jpg" width="300" height='75'></a></h1></div>
      <!-- <div class="menu_nav">
        <ul>
		...
		<div class="card">
            <div class="card-body" align="center">
              ...
              <tr>
				...
				<button><?php echo "<a style='color:red' href=hproedit.php?hid=".$row['hid']."><b>Edit</b></a>"; }?></button>
            </div>
        </div>
