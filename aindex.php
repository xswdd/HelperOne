...
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="aindex.php">Helpers</a></li>
            ...
            <?php
                  if(isset($_REQUEST['submit']))
                  {
                    ...
                    $name=$_POST['search'];
                      ...
                      if($name=='')
                      {
                            $sql="select * from helper order by hid";
                            $result = mysqli_query($conn, $sql);
                            echo "<table align='center' cellspacing='50'><tr>";
                            $count=0;
                            while($row2=mysqli_fetch_assoc($result))
                            ...
                            echo "<tr><td>Type</td><td>:</td>";
                            echo "<td>".$row2['type']."</td></tr>";
                            echo "<tr><td colspan='3'><center><a style='color:red' href=deleteh.php?id1=".$row2['hid'].">Delete</a></center> </td></tr>";
                            echo "</tbody></table>";
                            echo "</div>";
                            echo "</div>";
                            echo "</td>";
                    ...
                    $q="select * from helper where firstname='$name' or lastname='$name' or phone='$name' or type='$name' or area='$name' ";
